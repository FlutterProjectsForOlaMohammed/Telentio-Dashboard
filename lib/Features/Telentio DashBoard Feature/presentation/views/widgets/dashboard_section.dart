...
import 'package:telentio_dashboard/Features/Telentio%20DashBoard%20Feature/presentation/views/widgets/application_received_and_ratio_section.dart';
      ...
      child: Container(
        ...
        child: const Column(
          ...
          children: [
            ...
            ApplicationReceivedAndRatioSection(),
          ],
        ),
      ),
    );
